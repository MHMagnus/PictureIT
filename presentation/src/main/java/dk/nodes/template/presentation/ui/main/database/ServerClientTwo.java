...
import dk.nodes.template.presentation.util.SharedPreferenceUtil;
...
//    private static final String posturl = "http://192.168.1.200:5000";
    private static final String posturl = "http://192.168.0.102:5000";
    String TAG = "Server";
    private int id = 0;
    ...
    public void connectServer(final Context c, final List<String> paths) {
        System.out.println("test123 connectServer");
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    for (int i = 0; i < numberOfImages; i += SIZEOFBATCH) {
                        if (iterations > 0) {
                            ...
                            RequestBody fileRequestBody = new MultipartBody.Builder()
                                    ...
                                    .build();
                            Timber.d(fileRequestBody + "filerequestBody");
                    ...
                    VectorBaseHelper.Companion.exportDB();
    ...
    public File zip(String[] _files, String zipFileName) {
        String internalPath = "/data/data/" + MainActivity.Companion.getPackageName();
        ...
        try {
            ...
            e.printStackTrace();
            Log.i(TAG, "zip WAS NOT successful");
    ...
    private void getResponse(OkHttpClient client, Request fileRequest, final int id, Context c) {
        ...
        try
        {
            VectorLab vl = VectorLab.get(MainActivity.Companion.getContext());
